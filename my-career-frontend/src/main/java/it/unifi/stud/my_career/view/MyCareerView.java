...
public interface MyCareerView {
	...
	// Show a message when a student is added with success and update the student
	// list
	void studentAdded(String message, Student student);

	// Show a message when a student is removed with success and update the student
	// list
	void studentRemoved(String message, Student student);

	// Show an error message related to the course management (i.e. during login or
	// account removing)
	...
	// Show a message when a course is removed with success and update the course
	// list
